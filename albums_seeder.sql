...
('Fleetwood Mac', 'Rumours', 1977, 27.9, 'Soft Rock'),
 ('Various Artists', 'Grease: The original soundtrack from the motion picture', 1978, 29.0, 'Soundtrack'),
...
('Various Artists', 'Dirty Dancing', 1987, 17.9, 'Pop, R&B, Rock'),
...
('Dire Straits', 'Brothers in Arms', 1985, 17.7, 'Pop, Rock'),
('James Horner', 'TitanicL Music from the Motion Picture', 1997, 18.1, 'Soundtrack'),
